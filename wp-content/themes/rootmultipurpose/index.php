            ...
            <div class="row">
              <div class="col-md-5 col-sm-6">
                <div class="intro">
                  ...
                  <p class="wow fadeInDown" data-wow-delay="0.2s">Best in class virtual reality gear to make yours everyday experience great. Go check it.</p>
                  <a href="#" class="btn btn-action btn-fb wow fadeInDown" data-wow-delay="0.3s"><span>Buy Now</span></a>
                </div>
              </div>
              <div class="col-md-7 col-sm-6">
                <img class="img-responsive" src="<?php echo get_template_directory_uri().'/images/product.png';?>" alt="Feature" >
              </div>
            </div>
          </div>
        </div><!-- Pi-Hero -->
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="features-image wow fadeInRight">
                  <img class="img-responsive" src="<?php echo get_template_directory_uri().'/images/oculus.png';?>"  alt="Image" >
                </div>
              </div>
            </div>
          </div>
